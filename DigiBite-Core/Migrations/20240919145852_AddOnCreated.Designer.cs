...
namespace DigiBite_Core.Migrations
{
    ...
    [Migration("20240919145852_AddOnCreated")]
    partial class AddOnCreated
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("DigiBite_Core.Entities.Lookups.EmployeeDocument", b =>
                {
                    ...
                    b.Property<DateTime>("CreationDateTime")
                        ...
                        .HasDefaultValue(new DateTime(2024, 9, 19, 17, 58, 49, 772, DateTimeKind.Local).AddTicks(485));
            ...
            modelBuilder.Entity("DigiBite_Core.Entities.Lookups.EmployeeInformation", b =>
                {
                    ...
                    b.Property<DateTime>("CreationDateTime")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2024, 9, 19, 17, 58, 49, 772, DateTimeKind.Local).AddTicks(9689));
            ...
            modelBuilder.Entity("DigiBite_Core.Models.Entities.AppUser", b =>
                {
                    ...
                    b.Property<DateTime>("CreationDateTime")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2024, 9, 19, 17, 58, 49, 732, DateTimeKind.Local).AddTicks(3863));
                    ...
                    b.Property<DateTime>("LastModifiedDateTime")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2024, 9, 19, 17, 58, 49, 732, DateTimeKind.Local).AddTicks(4522));
            ...
            modelBuilder.Entity("DigiBite_Core.Models.Entities.Category", b =>
                {
                    ...
                    b.Property<DateTime>("CreationDateTime")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2024, 9, 19, 17, 58, 49, 774, DateTimeKind.Local).AddTicks(8130));
            ...
            modelBuilder.Entity("DigiBite_Core.Models.Entities.Ingredient", b =>
                {
                    ...
                    b.Property<DateTime>("CreationDateTime")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2024, 9, 19, 17, 58, 49, 775, DateTimeKind.Local).AddTicks(5020));
            ...
            modelBuilder.Entity("DigiBite_Core.Models.Entities.Item", b =>
                {
                    ...
                    b.Property<DateTime>("CreationDateTime")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2024, 9, 19, 17, 58, 49, 776, DateTimeKind.Local).AddTicks(2343));
            ...
            modelBuilder.Entity("DigiBite_Core.Models.Entities.Meal", b =>
                {
                    ...
                    b.Property<DateTime>("CreationDateTime")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2024, 9, 19, 17, 58, 49, 777, DateTimeKind.Local).AddTicks(1020));
            ...
            modelBuilder.Entity("DigiBite_Core.Models.Entities.Order", b =>
                {
                    ...
                    b.Property<DateTime>("CreationDateTime")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2024, 9, 19, 17, 58, 49, 777, DateTimeKind.Local).AddTicks(7837));
            ...
            modelBuilder.Entity("DigiBite_Core.Models.Lookups.Voucher", b =>
                {
                    ...
                    b.Property<DateTime>("CreationDateTime")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2024, 9, 19, 17, 58, 49, 773, DateTimeKind.Local).AddTicks(8106));
                    ...
                    b.Property<DateTime>("ScheduleStartDate")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2024, 9, 19, 17, 59, 9, 747, DateTimeKind.Local).AddTicks(2999));
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityRole", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = "6c1d17cf-a7da-4a87-af61-c80a51aa02a2",
                            Name = "Admin",
                            NormalizedName = "ADMIN"
                        },
                        new
                        {
                            Id = "f249e736-c7c7-429c-9bf0-19a930937d23",
                            Name = "Manager",
                            NormalizedName = "MANAGER"
                        },
                        new
                        {
                            Id = "a89be0d5-2017-447c-9082-8fab3872e833",
                            Name = "Waiter",
                            NormalizedName = "WAITER"
                        },
                        new
                        {
                            Id = "dc7dfdc2-0747-4d12-8b63-d14ab14e514e",
                            Name = "Chef",
                            NormalizedName = "CHEF"
                        },
                        new
                        {
                            Id = "03e8c969-0023-4e59-ac77-7d1f782a6485",
                            Name = "Cashier",
                            NormalizedName = "CASHIER"
                        },
                        new
                        {
                            Id = "3962c760-7bd1-404e-9b12-0ca4798fc4a2",
                            Name = "Delivery",
                            NormalizedName = "DELIVERY"
                        },
                        new
                        {
                            Id = "29412b25-5043-44cf-b439-d3299a0d11d0",
                            Name = "Customer",
