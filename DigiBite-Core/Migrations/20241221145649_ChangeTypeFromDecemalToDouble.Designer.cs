...
namespace DigiBite_Core.Migrations
{
    ...
    [Migration("20241221145649_ChangeTypeFromDecemalToDouble")]
    partial class ChangeTypeFromDecemalToDouble
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("DigiBite_Core.Entities.ManyToMany.CartItemAddon", b =>
                {
            ...
            modelBuilder.Entity("DigiBite_Core.Entities.ManyToMany.CartItemAddon", b =>
                {
                    b.HasOne("DigiBite_Core.Entities.Lookups.AddOn", null)
                        .WithMany()
                        .HasForeignKey("AddonId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("DigiBite_Core.Entities.ManyToMany.CartItem", null)
                        .WithMany()
            ...
            modelBuilder.Entity("DigiBite_Core.Models.Entities.Item", b =>
                {
                    b.HasOne("DigiBite_Core.Models.Entities.Category", null)
                        .WithMany()
